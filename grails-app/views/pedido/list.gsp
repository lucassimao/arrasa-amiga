			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="valorEmCentavosDeDolar" title="Valor (U\$)" />
					
						<g:sortableColumn property="valorEmCentavosDeReais" title="Valor (R\$)" />
				...
				<g:each in="${pedidoInstanceList}" status="i" var="pedidoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: pedidoInstance, field: "valorEmDolar")}</td>
					
						<td>${fieldValue(bean: pedidoInstance, field: "valorEmReais")}</td>
