    ...
    <div class="col-md-12 footer">
        <div class="row">
            <div class="col-md-3 col-xs-6">
                <div class="widget">
                    <h3><span class="whatsapp">Contatos</span></h3>
                    <address>
                        (86) 9910-8321  <br>
                        (86) 9915-9682  <br>
                        (86) 8835-3101  <br>
                        arrasa.amiga@gmail.com<br>
                    </address>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 copyright-right">
                <ul class="list-unstyled list-social">
                    <li><a target="_blank" href="http://www.facebook.com/arrasaamiga"><i
                            class="fa fa-facebook-square"></i></a></li>
                    <li><a target="_blank" href="http://instagram.com/arrasaamiga/"><i class="fa fa-instagram"></i></a>
                    </li>
