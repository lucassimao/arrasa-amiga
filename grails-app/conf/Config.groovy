...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
        ...
        '/index.gsp'            : ['permitAll'],
        '/assets/**'            : ['permitAll'],
        '/images/anexos/**'     : ['permitAll'],
        '/images/produtos/**'   : ['permitAll'],
        '/images/banners/**'    : ['permitAll'],
        '/plugins/**'           : ['permitAll'],
        '/console/**'           : ['ROLE_ADMIN']
]

grails.plugin.springsecurity.filterChain.chainMap = [
        '/sync/**': 'JOINED_FILTERS,-anonymousAuthenticationFilter,-exceptionTranslationFilter,-authenticationProcessingFilter,-rememberMeAuthenticationFilter',  // Stateless chain
        ...
        '/api/estoque/**': 'JOINED_FILTERS,-anonymousAuthenticationFilter,-exceptionTranslationFilter,-authenticationProcessingFilter,-rememberMeAuthenticationFilter',  // Stateless chain
