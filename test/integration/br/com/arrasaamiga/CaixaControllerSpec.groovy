...
class CaixaControllerSpec extends Specification {
    ...
    void "test calcular totais para o vendedor #username"(){
        ...
        then:
            ...
            json[username] != null
            json[username].total == total
            json[username].dinheiro == totalAVista
            json[username].cartao == totalAPrazo
            json[username].salario == salario
        ...
        where:
            ...
            'vendedor1'| 90000+22000-655 |   90000      | 22000 - 655   | 15*(90000+22000-655)/100.0
            'vendedor2'| 43395 - 982     |    0         | 43395 - 982   | 15*(43395 - 982)/100.0  
    ...
    void "test resultado da solicitação pelo Admin"(){
        ...
        where:
            /* os valores negativos sao os proporcionais das taxas de parcelamento para o produto */
            username   | total                            |  totalAVista | totalAPrazo               | salario
            'vendedor1'| 90000+22000-655                  |   90000      | 22000 - 655               | (90000+22000-655)*15L/100.0
            'vendedor2'| 43395 - 982                      |    0         | 43395 - 982               | (43395 - 982)*15L/100.0 
            'site'     | 40000 + 22000 - 185 + 12474 -1361|  40000       | 22000 - 185 + 12474 -1361 | (40000 + 22000 - 185 + 12474 - 1361)*15L/100.0
    ...
    void setup() {
        ...
        def produto1 = new Produto(descricao: 'Produto 1',nome: 'P1',precoAVistaEmCentavos:10000,precoAPrazoEmCentavos:11000,
                                    tipoUnitario: 'un1', unidades: ['un'] as List).save(flush: true,failOnError:true)

        def produto2 = new Produto(descricao: 'Produto 2',nome: 'P2', precoAVistaEmCentavos:20000,precoAPrazoEmCentavos:22000,
                                    tipoUnitario: 'un', unidades: ['un2'] as List).save(flush: true,failOnError:true)

        def produto3 = new Produto(descricao: 'Produto 3',nome: 'P3', precoAVistaEmCentavos:1890,precoAPrazoEmCentavos:2079,
        ...
        caixa = new Caixa(inicio: str2Date('01/12/2015 0:0:0'),fim: str2Date('31/12/2015 23:59:59')).save(flush:true,failOnError:true)
        ...
        def v1 = new Venda(status: StatusVenda.AguardandoPagamento, 
                                ...
                                cliente: new Cliente(nome:'Cliente 1',endereco: new Endereco(cidade: Cidade.teresina, uf: Uf.piaui)),
