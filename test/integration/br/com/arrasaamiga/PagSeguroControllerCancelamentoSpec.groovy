...
class PagSeguroControllerCancelamentoSpec extends Specification {
    ...
    def setup() {
        ...
        new Cliente(nome: 'Cliente de parnaiba', usuario: user1, dddTelefone: '99',telefone: '991987121', endereco: new Endereco(cidade: parnaiba, uf: Uf.piaui,cep:'64023620')).save(flush: true)
        new Cliente(nome: 'Cliente de Teresina', usuario: user2, dddTelefone: '99',telefone: '991987121', endereco: new Endereco(cidade: Cidade.teresina, uf: Uf.piaui)).save(flush: true)
